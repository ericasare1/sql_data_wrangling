...
df_appolo1 <- sqldf(
  "select                                                                                   
    ...
    CASE WHEN conserwl_mandatorypartsustainagcert=1|haveenvfarmplan=1|partbmp=1 THEN 1 ELSE 0 END AS posmindset_conserv,  
    ...
    conservationpayment_mosteffective, techassistance_mosteffective, extensionprog_mosteffective, conservationeasement_mosteffective,
    sustainabilitycert_mosteffective, regulation_mosteffective, 
