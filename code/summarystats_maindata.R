...
"select                                                                                                          -- <--Brief cmments on variablee groups-->
    ...
    CASE WHEN conservationpayment_rankagconserprg = 1 THEN 1 ELSE 0 END As conservationpayment_leasteffective,   -- How does these policies influence conservation dec
    CASE WHEN conservationpayment_rankagconserprg = 6 THEN 1 ELSE 0 END As conservationpayment_mosteffective,
    CASE WHEN techassistance_rankagconserprg = 1 THEN 1 ELSE 0 END As techassistance_leasteffective,
    CASE WHEN techassistance_rankagconserprg = 6 THEN 1 ELSE 0 END As techassistance_mosteffective,
    CASE WHEN extensionprog_rankagconserprg = 1 THEN 1 ELSE 0 END As extensionprog_leasteffective,
    CASE WHEN extensionprog_rankagconserprg = 6 THEN 1 ELSE 0 END As extensionprog_mosteffective,
    CASE WHEN conservationeasement_rankagconserprg = 1 THEN 1 ELSE 0 END As conservationeasement_leasteffective,
    CASE WHEN conservationeasement_rankagconserprg = 6 THEN 1 ELSE 0 END As conservationeasement_mosteffective,
    CASE WHEN sustainabilitycert_rankagconserprg = 1 THEN 1 ELSE 0 END As sustainabilitycert_leasteffective,
    CASE WHEN sustainabilitycert_rankagconserprg = 6 THEN 1 ELSE 0 END As sustainabilitycert_mosteffective,
    CASE WHEN regulation_rankagconserprg = 1 THEN 1 ELSE 0 END As regulation_leasteffective,
    CASE WHEN regulation_rankagconserprg = 6 THEN 1 ELSE 0 END As regulation_mosteffective,
    
    CASE WHEN firstchoice_cropinfo = 'Fertilizer or Ag Chemical Dealer' THEN 1 ELSE 0 END As chem_dealer_cropinfo,   -- first choice infor for crop prod and conservation
    CASE WHEN firstchoice_cropinfo = 'Seed Dealer' THEN 1 ELSE 0 END As seeddealer_cropinfo,
    CASE WHEN firstchoice_cropinfo = 'Regional Agricultural Extension Specialist' THEN 1 ELSE 0 END As regagextspecialist_cropinfo,
    CASE WHEN firstchoice_cropinfo = 'Private Crop consultant' THEN 1 ELSE 0 END As privcropconsultant_cropinfo,
    CASE WHEN firstchoice_cropinfo = 'University extension' THEN 1 ELSE 0 END As univsext_cropinfo,
    CASE WHEN firstchoice_cropinfo = 'Commodity groups' THEN 1 ELSE 0 END As commoditygrps_cropinfo,
